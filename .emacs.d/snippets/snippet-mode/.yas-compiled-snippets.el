...
(yas-define-snippets 'snippet-mode
                     '(("field" "\\${${1:${2:n}:}$3${4:\\$(${5:lisp-fn})}\\}$0" "${ ...  } field" nil nil nil nil nil nil)
                       ...
                       ("weakheadnormalform" "--An expression in weak head normal form has been evaluated to \n--the outermost data constructor or lambda \n--abstraction (the head)." "weakheadnormalform" nil nil nil nil nil nil)))
